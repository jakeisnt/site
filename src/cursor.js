...
text {
  ...
  return UI.svg("svg",
    {viewBox: "0 0 500 500"},
    UI.svg("path", {id: "curve", d: "M73.2,148.6c4-6.1,65.5-96.8,178.6-95.6c111.3,1.2,170.8,90.3,175.1,97" }),
    UI.svg("text", { width: 500 },
      UI.svg("textPath", {"xlink:href": "#curve"}, "Dangerous Curves Ahead")))();
