...
(def profiles
  [{:name "Mastodon" :url "https://merveilles.town/@jakeisnt" :user "jakeisnt"}
   ...
   {:name "Google Maps" :url "https://www.google.com/maps/contrib/109731430420919295575/" :user "Jake Chvatal"}
   {:name "Email" :url "mailto://jake+website@isnt.online" :user "jake @ ~"}
   {:name "OpenStreetMaps" :url "https://www.openstreetmap.org/user/jakeisnt" :user "jakeisnt"}
